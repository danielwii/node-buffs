(function (global, factory) {
  ...
  (factory((global.nodeBuffs = {}),global.crypto));
  ...
  var createConfigLoader = function (optionsLoader) {
  ...
  var Cryptor = /** @class */ (function () {
      ...
      Cryptor.prototype.passwordCompare = function (password, savedHash, savedSalt, prefix) {
          ...
          return savedHash === crypto.pbkdf2Sync(encryptedPassword, generatedSalt, this.iterations, this.keylen, this.digest)
              .toString('hex');
      };
      return Cryptor;
  }());
